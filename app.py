...
def signup():
    ...
    connection = pymysql.connect(host= "localhost", user="root", password="", database="frank_sokogarden")
...
def add_product():
    ...
    print(product_name, product_description, product_category, product_cost, product_cost, product_image)
    # get image file name 
    ...
    sql = '''
        insert into product_details (product_name, product_description, product_category, product_cost, product_image) values (%s, %s, %s, %s, %s)
        '''
